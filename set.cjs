...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Gifted~N2hd14Xw",
  ...
  AUTO_TYPING: process.env.AUTO_TYPING !== undefined ? process.env.AUTO_TYPING === 'true' : tue,
  ...
  PORT: process.env.PORT || "8000", /* Where App Will Listen On */
